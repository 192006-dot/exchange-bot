...
const F = {
  ...
  'nova-sbe':            { eu:1, sc:1, fh:3.0, pop:550,   coast:5,   mtn:30,   temp:28 },
  'copenhagen-bs':       { eu:1, sc:1, fh:1.5, pop:650,   coast:0,   mtn:400,  temp:22 },
  'sse-stockholm':       { eu:1, sc:1, fh:2.0, pop:980,   coast:0,   mtn:500,  temp:22 },
  'essec':               { eu:1, sc:1, fh:1.5, pop:65,    coast:180, mtn:500,  temp:25 },
  'st-gallen':           { eu:0, sc:1, fh:1.0, pop:80,    coast:400, mtn:5,    temp:21 },
  'wu-vienna':           { eu:1, sc:1, fh:1.0, pop:1950,  coast:300, mtn:20,   temp:27 },
  'trinity-dublin':      { eu:1, sc:0, fh:2.0, pop:590,   coast:0,   mtn:15,   temp:19 },
  'aston':               { eu:0, sc:0, fh:1.5, pop:1150,  coast:120, mtn:100,  temp:21 },
  'innsbruck':           { eu:1, sc:1, fh:1.0, pop:130,   coast:400, mtn:0,    temp:25 },
  'antwerpen':           { eu:1, sc:1, fh:1.0, pop:540,   coast:85,  mtn:200,  temp:23 },
  'uclouvain':           { eu:1, sc:1, fh:1.0, pop:30,    coast:130, mtn:150,  temp:22 },
  'hec-liege':           { eu:1, sc:1, fh:1.0, pop:200,   coast:150, mtn:30,   temp:23 },
  'ku-leuven':           { eu:1, sc:1, fh:1.0, pop:100,   coast:130, mtn:150,  temp:23 },
  'charles-prague':      { eu:1, sc:1, fh:1.0, pop:1300,  coast:500, mtn:100,  temp:25 },
  'aarhus':              { eu:1, sc:1, fh:1.5, pop:350,   coast:0,   mtn:800,  temp:21 },
  'aalto':               { eu:1, sc:1, fh:2.5, pop:660,   coast:0,   mtn:800,  temp:22 },
  'hanken':              { eu:1, sc:1, fh:2.5, pop:660,   coast:0,   mtn:800,  temp:22 },
  ...
  'frankfurt-school':    { eu:1, sc:1, fh:0.5, pop:770,   coast:500, mtn:40,   temp:25 },
  'fu-berlin':           { eu:1, sc:1, fh:1.0, pop:3700,  coast:150, mtn:500,  temp:24 },
  'lmu':                 { eu:1, sc:1, fh:0.5, pop:1490,  coast:500, mtn:50,   temp:24 },
  'mannheim':            { eu:1, sc:1, fh:0.5, pop:310,   coast:500, mtn:30,   temp:26 },
  ...
  'nhh':                 { eu:0, sc:1, fh:2.0, pop:290,   coast:0,   mtn:0,    temp:18 },
  'catolica-lisbon':     { eu:1, sc:1, fh:3.0, pop:550,   coast:5,   mtn:30,   temp:28 },
  'catolica-porto':      { eu:1, sc:1, fh:3.0, pop:230,   coast:5,   mtn:80,   temp:24 },
  ...
  'lund':                { eu:1, sc:1, fh:1.5, pop:95,    coast:15,  mtn:700,  temp:22 },
  'uppsala':             { eu:1, sc:1, fh:2.0, pop:170,   coast:70,  mtn:500,  temp:22 },
  'lausanne':            { eu:0, sc:1, fh:1.5, pop:140,   coast:400, mtn:20,   temp:25 },
  'zagreb':              { eu:1, sc:1, fh:1.5, pop:770,   coast:140, mtn:20,   temp:27 },

  // === North America ===
  'nyu-stern':           { eu:0, sc:0, fh:8.5, pop:8300,  coast:0,   mtn:80,   temp:29 },
  ...
  'purdue-krannert':     { eu:0, sc:0, fh:9.5, pop:45,    coast:900, mtn:600,  temp:29 },
  'texas-am':            { eu:0, sc:0, fh:10.5,pop:120,   coast:190, mtn:900,  temp:34 },
  'wisconsin-madison':   { eu:0, sc:0, fh:9.5, pop:280,   coast:900, mtn:1500, temp:27 },
  'tulane':              { eu:0, sc:0, fh:10.0,pop:370,   coast:10,  mtn:700,  temp:32 },
  'george-washington':   { eu:0, sc:0, fh:8.5, pop:700,   coast:50,  mtn:90,   temp:30 },
  'minnesota-carlson':   { eu:0, sc:0, fh:9.5, pop:430,   coast:1500,mtn:1500, temp:28 },
  'uc-berkeley':         { eu:0, sc:0, fh:11.0,pop:120,   coast:0,   mtn:20,   temp:22 },
  'florida-warrington':  { eu:0, sc:0, fh:10.0,pop:140,   coast:90,  mtn:500,  temp:33 },
  ...
  'simon-fraser':        { eu:0, sc:0, fh:10.0,pop:2650,  coast:0,   mtn:0,    temp:22 },
  ...
  'puc-chile':           { eu:0, sc:0, fh:14.0,pop:6800,  coast:100, mtn:10,   temp:28 },
  'itam':                { eu:0, sc:0, fh:11.0,pop:9200,  coast:280, mtn:0,    temp:24 },
  'tec-monterrey':       { eu:0, sc:0, fh:11.5,pop:1150,  coast:200, mtn:10,   temp:35 },
  'uba':                 { eu:0, sc:0, fh:13.0,pop:3100,  coast:0,   mtn:1200, temp:29 },
  'los-andes':           { eu:0, sc:0, fh:12.0,pop:7900,  coast:500, mtn:0,    temp:19 },
  'pacifico':            { eu:0, sc:0, fh:13.5,pop:10800, coast:0,   mtn:80,   temp:26 },

  // === East Asia ===
  'cuhk':                { eu:0, sc:0, fh:11.0,pop:7400,  coast:0,   mtn:0,    temp:31 },
  'hku':                 { eu:0, sc:0, fh:11.0,pop:7400,  coast:0,   mtn:0,    temp:31 },
  'city-hk':             { eu:0, sc:0, fh:11.0,pop:7400,  coast:0,   mtn:0,    temp:31 },
  'hkust':               { eu:0, sc:0, fh:11.0,pop:7400,  coast:0,   mtn:0,    temp:31 },
  'fudan':               { eu:0, sc:0, fh:10.5,pop:25000, coast:30,  mtn:200,  temp:32 },
  'sjtu-antai':          { eu:0, sc:0, fh:10.5,pop:25000, coast:30,  mtn:200,  temp:32 },
  ...
  'icu-japan':           { eu:0, sc:0, fh:12.0,pop:13900, coast:0,   mtn:80,   temp:30 },
  'snu':                 { eu:0, sc:0, fh:11.0,pop:9700,  coast:30,  mtn:0,    temp:29 },
  'yonsei':              { eu:0, sc:0, fh:11.0,pop:9700,  coast:30,  mtn:0,    temp:29 },
  'korea-university':    { eu:0, sc:0, fh:11.0,pop:9700,  coast:30,  mtn:0,    temp:29 },
  'sogang':              { eu:0, sc:0, fh:11.0,pop:9700,  coast:30,  mtn:0,    temp:29 },
  ...
  // === Africa / Middle East ===
  'stellenbosch':        { eu:0, sc:0, fh:11.0,pop:80,    coast:50,  mtn:0,    temp:28 },
...
// Replace `    highlights: [` per-block, using the id captured just before.
// Do it as a state-machine pass: walk blocks, find id, replace highlights.
const OPEN = '  {';
const out = [];
let i = 0;
let lastId = null;
